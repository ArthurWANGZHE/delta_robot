...
namespace Example
{
    public partial class P2P : Form
    {
        ...
        public void AbsThread()
        {
	        ...
	        if(st != 0)
	        {
                st = IMC_Pkg.PKG_IMC_MoveAbs(Global.g_handle, m_pos, m_startvel, 0, m_tgvel, 1, m_axis);
	        }
        ...
        public void DistThread()
        {
            ...
            if (st != 0)
            {
                st = IMC_Pkg.PKG_IMC_MoveDist(Global.g_handle, m_dist, m_startvel, 0, m_tgvel, 1, m_axis);
            }
